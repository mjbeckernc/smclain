**********************************************************************
*** Program:        \biometrics\499\499H01\analyses_mjb\CSR\macros\prod\mimpddt.sas
*** Programmer:     Matt Becker
*** Date Created:   30Jan2010
***
*** Input :         User-specified XLS from \499H01\analyses_mjb\CSR\doc\*.xls
***
*** Output:         User-specified
***
*** Purpose:        Retrieve DDT specs and merge with analysis files
***
*** Comments:
***
...
***
**********************************************************************;
%macro mimpddt (micsv=, miin=, miout=, mikeep=Y, mlbl=) ;
...
proc import out=oddt
    datafile="&ddt"
    dbms=xls replace;
    sheet='Analysis Variable Metadata' ;
run ;
