...
data toc_prog;
  ...
  call symput('title1',trim(title1));
...
%else %do;
  ...
  title1 j=l "&ptitle1";
  %if &nopage=Y %then %do;
    title2 j=l "&ptitle2" j=r  j=r "{Page} {\field{\*\fldinst { PAGE }}}\~{of}\~{\field{\*\fldinst {NUMPAGES }}}";
  %end;
  %else %do;
    title2 j=l "&ptitle2" j=r "[Page_00000_of_99999]"; *** j=r "{Page} {\field{\*\fldinst { PAGE }}}\~{of}\~{\field{\*\fldinst {NUMPAGES }}}";
  %end;
  */
  title1 j=l "&tabnum:  &title1" j=r "[Page_00000_of_99999]";
  %do i=2 %to &numtitle;
