********************************************************************************;
*** Program:        /nfsshare/sashls2/mattb/XMB111/snowfl_programs/snowfl_programs/rlae.sas
...
proc sort data=snowlib.ae out=ae;
  by usubjid;
  %if &subset ne %then %do;
    where &subset;
  %end;

proc sort data=snowlib.dm out=dm(keep=usubjid age);
  by usubjid;
